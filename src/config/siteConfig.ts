...
export const siteConfig = {
  ...
  social: [
    ...
    { name: "LinkedIn", url: "https://linkedin.com/in/codingwithjamal" },
  ...
  projects: [
    ...
    },
    {
      name: "bluefox-email",
      description:
        "A TypeScript client library for sending emails using Bluefox.email with type-safe API, subscriber management, webhooks, and comprehensive error handling",
    ...
    },
    {
      ...
      description:
        "A personal collection of poems and creative writing pieces showcasing thoughts, emotions, and storytelling abilities through verse",
  ...
  blogs: [
    {
      ...
      description:
        "Bluefox is a modern email API built on top of Amazon SES, designed for developers and SaaS teams. Whether you're sending transactional emails or integrating real-time webhooks in a serverless Convex backend, Bluefox simplifies the process.",
      date: "2025-04-23",
  ...
  metadata: {
    ...
    description:
      "Step into the future. A cyberpunk-inspired developer portfolio by Jamal Lyons.",
  },
};
