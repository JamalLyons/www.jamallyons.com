        ...
        if (e.key === "Enter") {
          ...
          if (command) {
            ...
            if (target?.startsWith("/")) {
              ...
              setCommandOutput(
                "A coding genius, a problem solver, and a quick learner.",
              );
              input.value = "";
      ...
      <body>
        ...
        {showHelp && (
          ...
          >
            <button
              type="button"
              className="bg-background border-2 border-accent/50 shadow-[0_0_40px_rgba(157,78,221,0.5)] max-w-2xl w-full max-h-[80vh] overflow-auto relative"
            ...
            >
              ...
              <div className="p-4 md:p-8">
                <h2 className="text-accent-glow text-2xl md:text-3xl font-bold font-mono mb-4 md:mb-6">
                  Available Commands
                </h2>

                <div className="space-y-2 md:space-y-4 text-text/80">
                  <div className="border-l-2 border-terminal pl-3 md:pl-4 py-1.5 md:py-2">
                    <div className="font-mono text-terminal text-xs md:text-sm">
                      &gt; home
                    </div>
                  ...
                  <div className="border-l-2 border-accent/50 pl-3 md:pl-4 py-1.5 md:py-2">
                    <div className="font-mono text-accent text-xs md:text-sm">
                      &gt; help
                    </div>
                    <div className="text-xs md:text-sm mt-1">
                  ...
                  <div className="border-l-2 border-accent/50 pl-3 md:pl-4 py-1.5 md:py-2">
                    ...
                    <div className="text-xs md:text-sm mt-1">
                      Clear boot session and return to login
                    </div>
                  </div>
        ...
        {commandOutput && (
          <div className="fixed bottom-20 md:bottom-24 left-1/2 transform -translate-x-1/2 z-50 animate-slide-up px-4 w-full max-w-[95vw] md:max-w-2xl">
            <div className="bg-background border-2 border-terminal/50 px-4 md:px-6 py-3 md:py-4 shadow-[0_0_20px_rgba(0,255,183,0.3)]">
              <pre className="text-terminal text-xs md:text-sm font-mono whitespace-pre-wrap">
                {commandOutput}
              </pre>
            </div>
          </div>
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Portfolio of Jamal Lyons, a backend engineer and computer science student specializing in full stack development, API design, and system architecture.",
      },
      {
        name: "keywords",
        content:
          "Jamal Lyons, backend engineer, full stack developer, computer science, portfolio, web development, API design, TypeScript, JavaScript, system architecture",
      },
      {
        name: "author",
        content: "Jamal Lyons",
