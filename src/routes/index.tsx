        ...
        <div className="space-y-4 text-left">
          ...
          {!bootComplete && (
            <div className="space-y-2 animate-flicker">
              ...
              {currentBootLine < bootSequence.length && (
                <span className="inline-block animate-blink text-terminal">
                  _
                </span>
              )}
            </div>
            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="pl-4 space-y-2 text-text/80">
                  <div>
                    • Type <span className="text-accent">&gt; help</span> to see
                    available commands
                  </div>
                  <div>
                    • Type <span className="text-accent">&gt; about</span> to
                    learn more
                  </div>
                  <div>
                    • Type <span className="text-accent">&gt; projects</span> to
                    see my work
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 pt-6 border-t border-border/30">
                ...
                <div className="pl-4 space-y-2 text-sm text-text/70">
                  ...
                  <div>
                    Status: <span className="text-terminal">ONLINE</span> | Last
